...
import com.yanan.framework.ant.channel.buffer.BufferHandleException;
import com.yanan.framework.ant.channel.socket.message.Message;
import com.yanan.framework.ant.channel.socket.message.MessageProvider;
...
import com.yanan.framework.ant.core.ChannelEventSource;
...
,SocketMessageChannelHandler{
	...
	public ByteBufferChannel<Message<SocktMessageType>> getBufferHandler() {
	...
	public BufferReady<Message<SocktMessageType>> getMessageWriteHandler() {
	...
	private BufferReady<Message<SocktMessageType>> messageWriteHandler;
	...
	public void initBuffer() {
		this.messageWriteHandler = new BufferReady<Message<SocktMessageType>> (){
			@Override
			...
			public void onMessage(Message<SocktMessageType> message) {
				try {
	...
	public void transport(T message) {
		...
		Message<SocktMessageType> protocolMessage;
		if(message instanceof Message) {
			protocolMessage = (Message<SocktMessageType>) message;
		}else {
...
//			System.err.println("写入数据:"+socketChannel.finishConnect());
	...
	public void setBufferHandler(ByteBufferChannel<Message<SocktMessageType>> bufferHandler) {
	...
	public void setMessageWriteHandler(BufferReady<Message<SocktMessageType>> messageWriteHandler) {
